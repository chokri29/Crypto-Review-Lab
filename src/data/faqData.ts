...
export const AVF_SECURITY_FAQ_ITEMS: FAQItem[] = [
  ...
  {
    category: 'avf',
    question: 'How does AVF Engine evaluate contract security signals, exploit vectors, and oracle dependencies?',
    definition: 'Telemetry-driven security scanner corroborating GoPlus/RugCheck bytecode findings, public audit records, and bounded scenario models.',
    tip: 'Evaluates observable on-chain security attributes, public audits, and conceptual scenario bounds without claiming live symbolic execution.',
    answer: 'AVF Engine integrates verified on-chain telemetry from security providers (GoPlus Security, RugCheck) and cross-references public audit records:\n\n- Access Control & Invariant Checks — Checks static security flags, mint/freeze authorities, and public audit disclosures for Checks-Effects-Interactions (CEI) controls.\n- Liquidity & Scenario Bounds — Evaluates narrative and mathematical bounds for liquidity unwinds and pool concentration based on observed TVL.\n- Oracle Dependencies — Reviews price feed sources, latency exposure, and declared fallback mechanisms.\n- Privileged Function Review — Surfaces owner-only functions, emergency pause mechanisms, and multisig timelock parameters from provider telemetry.'
  },
  {
    category: 'avf',
