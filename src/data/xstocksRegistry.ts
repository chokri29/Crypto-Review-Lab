...
export const XSTOCKS_REGISTRY: XStockRegistryItem[] = [
  {
    ...
    exchange: 'NASDAQ',
    coingeckoRwaId: 'apple',
    coingeckoId: 'apple-xstock',
    cmcSymbol: 'AAPLX',
    issuer: 'Backed Finance',
    issuerId: 'xstocks-ecosystem',
  ...
  },
  {
    ...
    exchange: 'NASDAQ',
    coingeckoRwaId: 'alphabet-class-a',
  ...
  },
  {
    ...
    exchange: 'NASDAQ',
    coingeckoRwaId: 'robinhood-markets',
  ...
  },
  {
    ...
    exchange: 'NASDAQ',
    coingeckoRwaId: 'invesco-qqq-etf',
  ...
  },
  {
    ...
    exchange: 'NYSE',
    coingeckoRwaId: 'spdr-s-p-500-etf-trust',
