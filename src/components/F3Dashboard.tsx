...
export const F3Dashboard: React.FC<F3DashboardProps> = ({
  ...
  const moduleCards = [
    ...
    },
    {
      ...
      details: avf04?.details || (currentF3Result ? 'Verifies scenario readiness and lifecycle state for stress-test inputs (TVL, live price, contract address). Tracks F1/F2 convergence-loop execution. Full numerical price-shock, liquidity-drain and slippage simulations are not currently attached.' : 'Scenario readiness verification standby.'),
      checks: [
